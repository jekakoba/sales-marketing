(() => {
    ...
    function spollers() {
        ...
        if (spollersArray.length > 0) {
            ...
            function initSpollerBody(spollersBlock, hideSpollerBody = true) {
                ...
                document.querySelector(".spollers__wrapper-item");
                if (spollerItems.length) spollerItems.forEach((spollerItem => {
                    ...
                    if (hideSpollerBody) {
                        ...
                        if (spollerTitle.closest(".spollers__wrapper-item")) spollerTitle.closest(".spollers__wrapper-item").classList.remove("_spoller-active");
                        spollerItem.open = true;
                ...
                if (el.closest("[data-spoller-title]") && el.closest("[data-spollers]")) {
                    ...
                    if (el.closest("[data-spollers]").classList.contains("_spoller-init")) {
                        ...
                        if (!spollersBlock.querySelectorAll("._slide").length) {
                            ...
                            if (spollerTitle.closest(".spollers__wrapper-item")) spollerTitle.closest(".spollers__wrapper-item").classList.toggle("_spoller-active");
    ...
    function initSliders() {
        ...
        if (document.querySelector(".courses__slider")) new swiper_core_Swiper(".courses__slider", {
        ...
        if (document.querySelectorAll(".slider-article").length > 0) document.querySelectorAll(".slider-article").forEach((sliderBlock => {
            ...
            if (mainSlider) new swiper_core_Swiper(mainSlider, {
                modules: [ Navigation, Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: 2,
